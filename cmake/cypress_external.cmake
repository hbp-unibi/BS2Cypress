...
if(UPDATE_CYPRESS)
    ExternalProject_Add(cypress_ext
        ...
        GIT_TAG               master
        CMAKE_ARGS            -DSTATIC_LINKING=${STATIC_LINKING} -DCMAKE_INSTALL_PREFIX:path=<INSTALL_DIR> -DCMAKE_BUILD_TYPE:STRING=${DCMAKE_BUILD_TYPE} -DPYTHON_VERSION_MAJOR=${PYTHON_VERSION_MAJOR}
        INSTALL_COMMAND 	  ""
